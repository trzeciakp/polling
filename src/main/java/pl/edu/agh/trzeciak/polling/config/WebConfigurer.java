...
import pl.edu.agh.trzeciak.polling.web.filter.CachingHttpHeadersFilter;
import pl.edu.agh.trzeciak.polling.web.filter.StaticResourcesProductionFilter;
import pl.edu.agh.trzeciak.polling.web.filter.gzip.GZipServletFilter;
